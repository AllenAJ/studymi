  ...
  return (
    <div className="flex flex-col items-center justify-center w-full py-4 animate-scale-in">
      <div className="flex items-center gap-4 mb-10 w-full max-w-lg">
        ...
        <div className="h-1.5 flex-1 bg-softBorder dark:bg-darkBorder rounded-full overflow-hidden">
          <div 
            className="h-full bg-primaryGold transition-all duration-500 rounded-full" 
      ...
      >
        <div className={`relative w-full h-full duration-700 transform-style-3d transition-transform cubic-bezier(0.4, 0, 0.2, 1) ${isFlipped ? 'rotate-y-180' : ''}`}>
          {/* Front */}
          <div className="absolute w-full h-full bg-white dark:bg-darkCard rounded-[40px] shadow-soft border border-softBorder dark:border-darkBorder p-12 flex flex-col items-center justify-center backface-hidden hover:shadow-hover transition-all">
            <div className="w-12 h-12 bg-iceGray dark:bg-darkBorder rounded-full flex items-center justify-center mb-6">
            ...
            <div className="absolute bottom-8 text-steelGray dark:text-darkMuted text-sm flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity bg-iceGray dark:bg-darkBorder px-5 py-2.5 rounded-full font-medium">
              <RotateCw className="w-4 h-4" /> tap to flip
            </div>
          </div>

          {/* Back */}
          <div className="absolute w-full h-full bg-deepNavy dark:bg-[#000000] rounded-[40px] shadow-modal p-12 flex flex-col items-center justify-center backface-hidden rotate-y-180 border border-deepNavy dark:border-darkBorder">
      ...
      <div className="flex items-center gap-6 mt-12">
        ...
        <button 
          ...
          className="w-16 h-16 rounded-full bg-primaryGold text-white shadow-lg shadow-yellow-200/50 hover:bg-yellow-500 disabled:opacity-30 disabled:cursor-not-allowed flex items-center justify-center transition-all active:scale-95"
        >
